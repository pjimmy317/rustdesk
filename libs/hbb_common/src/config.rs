...
pub const RENDEZVOUS_SERVERS: &[&str] = &["jxch.online"];
pub const PUBLIC_RS_PUB_KEY: &str = "1234567890";
...
pub mod keys {
    ...
    pub const OPTION_API_SERVER: &str = "http://jxch.online:21114";
